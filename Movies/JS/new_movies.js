$(document).ready(function(){	
	...
	// 				cast = _.zip( _.pluck(result['credits']['cast'], "character"),
	// 					_.pluck(result['credits']['cast'], "name"),
	// 					_.pluck(result['credits']['cast'], "profile_path")).toString()
	// 				videos = _.pluck(result['videos']['results'], "key").toString();
